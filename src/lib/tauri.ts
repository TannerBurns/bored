...
export async function installCatalogCommandsToAllProjects(filenames: string[]): Promise<void> {
  return invoke('install_catalog_commands_to_all_projects', { filenames });
}
