...
export function Ticket({ ticket, onClick }: TicketProps) {
  ...
  return (
    <div
      ...
      onClick={handleClick}
      className={cn(
        'glass-intense p-3 rounded-xl cursor-pointer border border-orange-300/40 border-l-4 transition-all duration-200',
        'hover:shadow-lg hover:-translate-y-0.5 hover:border-orange-400/60',
