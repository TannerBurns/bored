// Official brand icons for Claude and Cursor agents
...
// Official Claude AI sunburst symbol (from Bootstrap Icons, CC0 license)
// Brand color: terracotta/rust-orange #da7756
...
// Cursor IDE cube logo (based on official brand guidelines)
export function CursorIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
